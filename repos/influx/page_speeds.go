...
func NewPageSpeedReportRepository(bucket string, writeAPI api.WriteAPIBlocking, queryAPI api.QueryAPI, db *sql.DB) PageSpeedReportRepository {
	return &pageSpeedReportRepository{
		bucket:   bucket,
		writeAPI: writeAPI,
		queryAPI: queryAPI,
		db:       db,
