...
type Order struct {
	...
	GatewayOrderID        null.String `boil:"gateway_order_id" json:"gateway_order_id,omitempty" toml:"gateway_order_id" yaml:"gateway_order_id,omitempty"`
	GatewayCreateResponse null.JSON   `boil:"gateway_create_response" json:"gateway_create_response,omitempty" toml:"gateway_create_response" yaml:"gateway_create_response,omitempty"`
	GatewayVerifyResponse null.JSON   `boil:"gateway_verify_response" json:"gateway_verify_response,omitempty" toml:"gateway_verify_response" yaml:"gateway_verify_response,omitempty"`
...
var OrderColumns = struct {
	...
	GatewayCreateResponse: "gateway_create_response",
	GatewayVerifyResponse: "gateway_verify_response",
...
var OrderTableColumns = struct {
	...
	ID:                    "orders.id",
	AccountID:             "orders.account_id",
	ProjectID:             "orders.project_id",
	PackageID:             "orders.package_id",
	GatewayID:             "orders.gateway_id",
	Status:                "orders.status",
	Amount:                "orders.amount",
	GatewayOrderID:        "orders.gateway_order_id",
	GatewayCreateResponse: "orders.gateway_create_response",
	GatewayVerifyResponse: "orders.gateway_verify_response",
...
var OrderWhere = struct {
	...
	GatewayOrderID        whereHelpernull_String
	GatewayCreateResponse whereHelpernull_JSON
	GatewayVerifyResponse whereHelpernull_JSON
	CreatedAt             whereHelpertime_Time
	UpdatedAt             whereHelpertime_Time
	DeletedAt             whereHelpernull_Time
}{
	ID:                    whereHelperint{field: "\"orders\".\"id\""},
	AccountID:             whereHelperint{field: "\"orders\".\"account_id\""},
	ProjectID:             whereHelperint{field: "\"orders\".\"project_id\""},
	PackageID:             whereHelperint{field: "\"orders\".\"package_id\""},
	GatewayID:             whereHelperint{field: "\"orders\".\"gateway_id\""},
	Status:                whereHelperstring{field: "\"orders\".\"status\""},
	Amount:                whereHelperint{field: "\"orders\".\"amount\""},
	GatewayOrderID:        whereHelpernull_String{field: "\"orders\".\"gateway_order_id\""},
	GatewayCreateResponse: whereHelpernull_JSON{field: "\"orders\".\"gateway_create_response\""},
	GatewayVerifyResponse: whereHelpernull_JSON{field: "\"orders\".\"gateway_verify_response\""},
...
type orderR struct {
	...
	Gateway *Gateway `boil:"Gateway" json:"Gateway" toml:"Gateway" yaml:"Gateway"`
...
func (r *orderR) GetGateway() *Gateway {
	if r == nil {
		return nil
	}
	return r.Gateway
...
func (r *orderR) GetPackage() *Package {
	if r == nil {
		return nil
	}
	return r.Package
...
var (
	orderAllColumns            = []string{"id", "account_id", "project_id", "package_id", "gateway_id", "status", "amount", "gateway_order_id", "gateway_create_response", "gateway_verify_response", "created_at", "updated_at", "deleted_at"}
	orderColumnsWithoutDefault = []string{"account_id", "project_id", "package_id", "gateway_id", "status", "amount", "created_at", "updated_at"}
	orderColumnsWithDefault    = []string{"id", "gateway_order_id", "gateway_create_response", "gateway_verify_response", "deleted_at"}
...
func (o *Order) Gateway(mods ...qm.QueryMod) gatewayQuery {
	queryMods := []qm.QueryMod{
...
func (o *Order) Package(mods ...qm.QueryMod) packageQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (orderL) LoadGateway(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrder interface{}, mods queries.Applicator) error {
	var slice []*Order
	var object *Order
	...
	query := NewQuery(
		qm.From(`gateways`),
		qm.WhereIn(`gateways.id in ?`, args...),
		qmhelper.WhereIsNull(`gateways.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (orderL) LoadPackage(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrder interface{}, mods queries.Applicator) error {
	var slice []*Order
	var object *Order
...
// SetGateway of the order to the related item.
// Sets o.R.Gateway to related.
// Adds o to related.R.Orders.
func (o *Order) SetGateway(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Gateway) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
// SetPackage of the order to the related item.
// Sets o.R.Package to related.
// Adds o to related.R.Orders.
func (o *Order) SetPackage(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Package) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
func Orders(mods ...qm.QueryMod) orderQuery {
	mods = append(mods, qm.From("\"orders\""), qmhelper.WhereIsNull("\"orders\".\"deleted_at\""))
	q := NewQuery(mods...)
...
func FindOrder(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Order, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"orders\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
...
func (o *Order) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = fmt.Sprintf("UPDATE \"orders\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
...
func (o OrderSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"orders\" SET %s WHERE "+
...
func OrderExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"orders\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
