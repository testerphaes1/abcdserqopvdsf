...
type Faq struct {
	...
	Question  null.String `boil:"question" json:"question,omitempty" toml:"question" yaml:"question,omitempty"`
...
var FaqWhere = struct {
	ID        whereHelperint
	Question  whereHelpernull_String
	Answer    whereHelpernull_String
	CreatedAt whereHelpertime_Time
	UpdatedAt whereHelpertime_Time
	DeletedAt whereHelpernull_Time
}{
	ID:        whereHelperint{field: "\"faq\".\"id\""},
	Question:  whereHelpernull_String{field: "\"faq\".\"question\""},
	Answer:    whereHelpernull_String{field: "\"faq\".\"answer\""},
	CreatedAt: whereHelpertime_Time{field: "\"faq\".\"created_at\""},
	UpdatedAt: whereHelpertime_Time{field: "\"faq\".\"updated_at\""},
	DeletedAt: whereHelpernull_Time{field: "\"faq\".\"deleted_at\""},
}
...
var (
	faqAllColumns            = []string{"id", "question", "answer", "created_at", "updated_at", "deleted_at"}
	faqColumnsWithoutDefault = []string{"created_at", "updated_at"}
	faqColumnsWithDefault    = []string{"id", "question", "answer", "deleted_at"}
	faqPrimaryKeyColumns     = []string{"id"}
...
func (q faqQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Faq, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for faq")
	}
...
func (q faqQuery) All(ctx context.Context, exec boil.ContextExecutor) (FaqSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Faq slice")
	}
...
func (q faqQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count faq rows")
	}
...
func (q faqQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if faq exists")
	}
...
func Faqs(mods ...qm.QueryMod) faqQuery {
	mods = append(mods, qm.From("\"faq\""), qmhelper.WhereIsNull("\"faq\".\"deleted_at\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"faq\".*"})
	}
...
func FindFaq(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Faq, error) {
	faqObj := &Faq{}
	...
	query := fmt.Sprintf(
		"select %s from \"faq\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from faq")
	}
...
func (o *Faq) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no faq provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"faq\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"faq\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into faq")
	}
...
func (o *Faq) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update faq, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"faq\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update faq row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for faq")
	}
...
func (q faqQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for faq")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for faq")
	}
...
func (o FaqSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"faq\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in faq slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all faq")
	}
	return rowsAff, nil
}
...
func (o *Faq) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models: no faq provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert faq, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"faq\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert faq")
	}
...
func (o *Faq) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no Faq provided for delete")
	}
	...
	if hardDelete {
		...
		sql = fmt.Sprintf("UPDATE \"faq\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
		valueMapping, err := queries.BindMapping(faqType, faqMapping, append(wl, faqPrimaryKeyColumns...))
		if err != nil {
			return 0, err
		}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from faq")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for faq")
	}
...
func (q faqQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no faqQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from faq")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for faq")
	}
...
func (o FaqSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	if hardDelete {
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"faq\" SET %s WHERE "+
			strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 2, faqPrimaryKeyColumns, len(o)),
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from faq slice")
	}
...
func (o *FaqSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in FaqSlice")
	}
...
func FaqExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"faq\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if faq exists")
	}
...
func (o *Faq) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return FaqExists(ctx, exec, o.ID)
}
